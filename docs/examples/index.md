...
<div class="example-grid">
  ...
  <a class="example-card" href="./plugin/context-menu">
    <div class="example-card__icon">📋</div>
    <h3>右键菜单</h3>
    <p>右键弹出自定义上下文菜单。</p>
  </a>
  <a class="example-card" href="./plugin/tooltip">
    <div class="example-card__icon">💬</div>
    <h3>悬停提示</h3>
    <p>鼠标悬停节点显示 tooltip。</p>
  </a>
  <a class="example-card" href="./plugin/edit-label">
    <div class="example-card__icon">✏️</div>
    <h3>标签编辑</h3>
    <p>双击节点 inline 编辑 label。</p>
  </a>
